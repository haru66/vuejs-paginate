<template>
  <ul :class="containerClass" v-if="!noLiSurround">
    ...
    <li v-for="page in pages" v-bind:key="page.index" :class="[pageClass, page.selected ? activeClass : '', page.disabled ? disabledClass : '', page.breakView ? breakViewClass: '']">
  ...
  <div :class="containerClass" v-else>
    ...
    <template v-for="page in pages">
      <a v-if="page.breakView" :key="page.index" :class="[pageLinkClass, breakViewLinkClass, page.disabled ? disabledClass : '']" tabindex="0">
